...
for ix = 1:1
    ...
    load(sprintf('/Users/caseydiekman/Google Drive/My Drive/Summer-Research-2022/data/simulated_ECG_trace%d.mat',hour));
...
%    dlmwrite(sprintf('ECG_features_TSD-16_25aug_hour%d.csv',hour),output,'precision',10)
    dlmwrite(sprintf('ECG_features_simulated_trace%d.csv',hour),output,'precision',10)
